...
# directory
#
410TESTS = cvar_test mutex_destroy_test misbehave_wrap misbehave cyclone agility_drill join_specific_test multitest paraguay juggle racer largetest rwlock_downgrade_read_test stack_test1 wild_test1 switzerland
...
###########################################################################
THREAD_OBJS = malloc.o panic.o asm_xchg.o mutex.o queue.o thr_create_kernel.o thr_lib.o thr_lib_helper.o arraytcb.o cond_var.o asm_get_esp.o hashtable.o sem.o rwlock.o asm_thr_exit.o
